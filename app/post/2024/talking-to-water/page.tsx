        ...
        <>
            ...
            <Section>
                ...
                <Text>
                    ...
                    <em>“I don’t know, but let’s figure it out together”</em>,
                    this answer was no different.
                </Text>
                <Text>
                ...
                <Text>
                    Making prototypes work just enough to convey a concept. No
                    need for perfection, fault-proof code or future-proof
                    solutions.
                </Text>
            </Section>
            <Section>
                ...
                <Text>
                    Put simply the concept is to use sentiment analysis to
                    detect the <em>emotions</em> of the words we say.
                </Text>
                <Text>
                    These emotions are then used as the input for generative art
                    in the <code>AuraMotions</code> installation.
                </Text>
            </Section>
            <Section>
                <Text as="h2" variant="subheading">
                ...
                <Text>
                    In order to <em>talk to water</em> the problem was broken
                    down into:
                </Text>
                <Text as="ol">
                    <li>
                    ...
                    <li>
                        <strong>Sentiment analysis</strong> — determine the
                        emotions of those words
                    </li>
                    <li>
            ...
            <Section>
                ...
                <Text>
                    ...
                    anymore. But did you know OpenAI has a forgotten little
                    brother, especially after the release of{" "}
                ...
                <Text>
                    ...
                    open-sourced model for easy, free and local use.
                </Text>
                <CodeBlock
                    code={`
\`\`\`python
...
\`\`\`
            ...
            <Section>
                ...
                <Text>
                    Now that we have the text, we need to determine the{" "}
                    <em>emotion</em> of the words. Are they positive, negative,
                    neutral or …?
                </Text>
                <Text>
                    A tool I have been wanting to play around with for a while
                    now was{" "}
...
\`\`\`
                ...
                <Text>
                    reasonably accurate sentiment analysis with a few lines of
                    code.
                </Text>
            </Section>
            <Section>
                ...
                <Text>
                    In architecture rooms this would be a hot-topic. Having
                    multiple sessions to discuss the up- and down-sides of
                    different streaming protocols. Calculating throughput needs,
                    determine latency requirements and write-up reliability
                    specifications.
                </Text>
                <Text>
                    But we are bodging things over here, we <em>just</em> need
                    to send some data from one tool to another tool.
                </Text>
                <Text>
                ...
                <Text>
                    ...
                    would probably have been a better fit for the job we used
                    MQTT as it was already there, configured, and known to work.
                </Text>
                <CodeBlock
                    code={`
\`\`\`python
...
\`\`\`
                ...
                <Text>
                    From here on out the students could use emotions sent by the
                    MQTT messages to create any (generated) visual
            ...
            <Section>
                ...
                <Text>
                    By standing on the shoulder of giants, we can bodge together
            ...
            <Section className="mt-96">
                ...
                <Text>
                    That means you are realy bored or a super nerd, either way
                    let us go!
                </Text>
            </Section>
            <Section>
                ...
                <Text>
                    While the code presented above worked on my machine, and
                    probably works on your machine with some technical
                    knowledge, the bodged solution is not without its flaws.
                </Text>
                <Text>
                    While the project runs fine when all tools and dependencies
                    are available, it was breaking down when the students tried
                    to run it on their own machines.
                </Text>
                <Text>
                    Either (the correct version of) python was not installed or
                    dependencies, like <code>ffmpeg</code>, were not available
            ...
            <Section>
                ...
                <Text>
                    Mismatching versions and missing dependencies is a common
                    and solved problem in software development.
                </Text>
                <Text>
...
\`\`\`
                ...
                />
                <Text>
                    Voil&agrave;, packaging the whole project neatly in a docker
                    container will solve all our problems right?
                </Text>
            ...
            <Section>
                ...
                <Text>
                    While docker solved the problem of dependencies, it
                    introduced a new problem.
                </Text>
                <Text>
                    Audio was not being captured by the container, at least not
                    on macOS machines.
                </Text>
                <Text>
                    We don’t have the luxury of running docker with{" "}
                    <code>--device /dev/snd</code> as you would on a linux
                    machine.
                </Text>
                <Text>
                    ...
                    which could{" "}
                    <em>”[…] transfer audio to a different machine […]”</em>.
                </Text>
                <Text>
                    This could be to a machine on the other side of the room,
                    building, city, world or to a docker container running on
                    the same machine.
                </Text>
                <Text>
                    To make installing <code>PulseAudio</code> as easy as
                    possible for the students, I wrote a small bash script.
                </Text>
                <CodeBlock
                    code={`
\`\`\`sh
...
\`\`\`
                ...
                />
                <Text>
                    So finally, the students (and you) can run the project with
                    two simple commands:
                </Text>
                <Text as="ol">
                    <li>
                    ...
                    <li>
                        <code>
                            docker run --net=host --privileged -e
                            PULSE_SERVER=_HOST_IP_
