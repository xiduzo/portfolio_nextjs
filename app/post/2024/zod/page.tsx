        ...
        <>
            ...
            <Section>
                <Text>
                    ...
                    find lacking compared to a real strongly type language: the
                    runtime validation of the data.
                </Text>
                <Text>
                    While a static type checker esnures everything{" "}
                    <em>works</em>, eventually we have to interact with the
                    scary outside world.
                </Text>
                <Text>
                    This can include user input, API responses, streamed data,
                    reading data from disk or even loading environment
                    variables.
                </Text>
            </Section>
            <Section>
                ...
                <Text>
                    ...
                    interface. This will set you —and your team— up for a world
                    of unnecessary debug sessions.
                </Text>
                <Text className="mt-60">
                    Let&apos;s say you have a neat generic function that fetches
                    data from an API:
                </Text>
                <CodeBlock
                    code={`
...
\`\`\`
                ...
                />
                <Text>
                    You have properly declared an interface for the data you
                    expect:
                </Text>
                <CodeBlock
                    code={`
...
\`\`\`
                ...
                />
                <Text>
                    And when you call the function you expect to get the data
                    you want:
                </Text>
                <CodeBlock
                    code={`
...
\`\`\`
                ...
                />
                <Text>
                    At first glance the interface looks fine, the function has
                    explicit type inputs and outputs.
                </Text>
                ...
                <Text as="ol">
                    ...
                    <li>
                        The function can throw an error, but you do not know
                        that from the interface. You are{" "}
                ...
                <Text>
                    You can easily spot those lies in source code whenever you
                    see an <code>as T</code> which should be read as{" "}
                    <code>as LIE</code>.
                </Text>
            </Section>
            <Section>
                ...
                <Text>
                    We can enhance the interface by adding a runtime validation
                    library like{" "}
                    <Link target="_blank" href="https://zod.dev">
                        Zod
                    </Link>
                    <sup>1</sup>. This requires some initial extra typing, but
                ...
                <Text as="aside" className="mt-8 text-base">
                    <ol>
                        <li>
                            ...
                            for JavaScript. But be aware that there is{" "}
                            <Link
                                target="_blank"
                                href="https://zod.dev/?id=comparison"
                            >
                                more out there
                            </Link>
                            .
...
\`\`\`
                ...
                />
                <Text>
                    Now, when we call the function, we are sure that the data we
                    get is according to the schema. And if not, we get proper
                    typed errors.
                </Text>
                <CodeBlock
                    code={`
...
\`\`\`
            ...
            <Section>
                ...
                <Text>
                    ...
                    , we are dealing with unstructured data from various
                    sources.
                </Text>
                <Text>
                    Growy is revolutionizing vertical farming by heavily relying
                    on (hundreds of) IoT devices sending and receiving data
                    to/from the cloud.
                </Text>
                <Text>
                    Our software is handling data from two primary sources:
                    DynamoDB and MQTT messages.
                </Text>
                <Text>
                    In the software, there was efford put into data-classes that
                    allow for creating data objects for static type-safety.
                </Text>
                <CodeBlock
                    code={`
\`\`\`typescript
...
\`\`\`
                ...
                />
                <Text>
                    But, you might have noticed some <code>as LIE</code>s in the
                    code.
                </Text>
                <Text>
                ...
                <Text>
                    While all interfaces and static types are correct, runtime
                    data could still be (and sometimes was) wrong.
                </Text>
            </Section>
            <Section>
                ...
                <Text>
                    As we tested our platform with simulated (IoT) devices,
                    everything seemed to work smoothly. But when the simulated
                    devices were being replaced by their actual real-world
                    counterparts, that is when things got interesting.
                </Text>
                <Text>
                    When we started to get actual data from the real world, bugs
                    started to surface. The data we were expecting and worked
                    with in our simulated environment was not always the correct
                    data. The interfaces from{" "}
                    <em>&ldquo;the hardware team&rdquo;</em> and{" "}
                    <em>&ldquo;the software team&rdquo;</em> were not always in
                    sync.
                </Text>
                <Text>
                    Some bugs were found immediately, as the services started
                    breaking down when the wrong data was received:
                </Text>
                <Text>
                    <code>
                ...
                <Text>
                    But some bugs were more subtle. Wrongly received data was
                    stored in the DynamoDB table and only processed in later
                    stages, making it harder to identify the root cause.
                </Text>
            </Section>
            <Section>
                <Text as="h3" variant="subheading" size="sm">
                ...
                <Text>
                    ...
                    incorrectly, we introduced runtime validation to our data
                    objects.
                </Text>
                <Text>
                    When I joined the project, which was already quite large, it
                    had adopted a heavy Object-Oriented Programming (OOP) style.
                    The data objects were used exetensively throughout the
                    codebase. As a result, we decided to not go full-in on{" "}
                    <em>the zod way</em>.
                </Text>
                <Text>
                    Instead, we opted for a hybrid approach, adding zod parsing
                    capabilities to the existing classes. This involved some
                    TypeScript magic, but allowed us to leverage the benefits of
                    runtime validation without disrupting the overall codebase
                    structure.
                </Text>
            </Section>
            ...
            <Section>
                <Text>
                    ...
                    foundation for our runtime validation framework:
                </Text>
                <CodeBlock
                    code={`
\`\`\`typescript
...
\`\`\`
                ...
                />
                <Text>
                    Okay, busted. In our code we also use some{" "}
                    <code>as LIE</code>s, but let me break it down.
                </Text>
                <Text as="code" className="mt-16 inline-block">
                    data as Input
                </Text>
                <Text>
                    Our constructor requires an <code>Input</code> type and does
                    not allow the <code>unknown</code> data we pass to the{" "}
                ...
                <Text>
                    A double <code>LIE</code>! To make your IDE happy we need to
                    return any form of our <code>GeneratedParsable</code>{" "}
                    interface.
                </Text>
                <Text>
                    As the <em>shape</em> of the schema can be (almost)
                    anything, typescript will infer everything from the generics
                    <code>Output</code>, <code>TypeDef</code> and{" "}
                    <code>Input</code> and use them in the
                    <code>GeneratedParsable</code> interface.
                </Text>
            </Section>
            <Section>
                <Text>
                    Luckely, all of the above happens behind the scenes and we
                    can extend the <code>Parsable</code> in the data objects to
                    give it runtime validation capabilities.
                </Text>
                <CodeBlock
                    code={`
\`\`\`typescript
...
\`\`\`
                ...
                <Text>
                    ...
                    <code>Parsable</code> class will be validated using the
                    schema and giving type-hints in the IDE. Adding some extra
                    static type checking magic to the mix.
                </Text>
                <CodeBlock
                    code={`
\`\`\`typescript
...
\`\`\`
                ...
                />
                <Text>
                    From this moment onwards we can be sure the data we are
                    working with is in the expected format, no more need for{" "}
                    <code>as LIE</code>s.
                </Text>
                <Text>
            ...
            <Section>
                ...
                <Text>
                    After implementing runtime validation, services started
                    reporting a lot more faulty data inputs. Initially, the team
                    was not very pleased with the constant need for fixing{" "}
                    <em>unnecessary errors</em>. Instead of adding new features
                    the focus was on data integrity for nearly a full month.
                </Text>
                <Text>
                    However, as time passed, received data became increasingly
                    in line with the expected format. This led to better
                    discussions between teams about data formats and interfaces,
                    as faulty data would no longer be accepted.
                </Text>
                <Text>
            ...
            <Section>
                ...
                <Text>
                    While the hybrid approach worked well for this project, it
                    is not perfect. For instance, it does not work with more
                    complex types like like{" "}
                    ...
                    <Link
                        target="_blank"
                        href="https://zod.dev/?id=intersections"
                    >
                        intersections
                    </Link>
                    .
                ...
                <Text>
                    When starting a new project, I would personally be going
                    full-in on <em>the zod way</em>. This would remove the need
                    for the <code>Parsable</code> entirely.
                </Text>
                <CodeBlock
                    code={`
\`\`\`typescript
...
\`\`\`
                ...
                />
                <Text>
                    You could then use the <code>GrowthCycle</code> type when
                    only type information is needed.
                </Text>
                <CodeBlock
                    code={`
\`\`\`typescript
...
\`\`\`
                ...
                />
                <Text>
                    Or pass the <code>GrowthCycle</code> zod object when data
