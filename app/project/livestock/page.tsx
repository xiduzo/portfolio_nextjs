  ...
  return (
    <>
      ...
      <Section>
        ...
        <Text>
          Can we somehow simplify the concept of blockchain so that it’s
      ...
      <Section>
        <Text>
          The technology that underpins Bitcoin is called blockchain, which
          initially began as a way to offer an alternative to the traditional
          financial system. However, blockchain has gradually been adopted by
        ...
        <Text>
          ...
          is researching how cryptocurrency wallets can be designed to help more
          people understand the impact of blockchain technology. Their aim is to
          determine what constitutes good or bad wallet design.
        </Text>
      </Section>
      ...
      <Section>
        ...
        <Text>
          The blockchain and cryptocurrencies can be complex and difficult to
          understand. Because of its global influence it is important to make
          them accessible for discussion and use.
        </Text>
        <Text>
          Potential users face many options for currencies, wallets, and
          services and require knowledge to avoid errors.
        </Text>
      </Section>
      <Section
      ...
      <Section>
        ...
        <Text>
          By creating the research tool for the Institute of Network Cultures
          (INC) we facilitate a study on how cryptocurrency wallets can be
          designed to facilitate a broader understanding of the influence of
          blockchain technology and define what good or bad wallet design is.
        </Text>
      </Section>
      <Section
        className='grid grid-cols-12 gap-4 lg:gap-6 xl:gap-12'
      ...
      <Section>
        ...
        <Text>
          Individuals who own cryptocurrency can utilize digital wallets to
          access their funds. These applications streamline the process of
          purchasing digital currencies, but they may obscure the inner workings
      ...
      <Section>
        ...
        <Text>
          Livestock is a multiplayer research tool that utilizes the human
          brains&apos; ability to subconsciously learn abstract and complex
          concepts.
        </Text>
        <Text>
          While it may appear to be another <em>Farmville-style</em> game, it is
          actually based on the blockchain technology that supports
          cryptocurrencies.
        </Text>
        <Text>
          LiveStock adds abstract blockchain concepts as layers to the game and
          simulates the blockchain market through the farm in a real-time
          multiplayer game.
        </Text>
      </Section>
      <Section variant='full' as='figure'>
      ...
      <Section>
        ...
        <Text>
          For example, Bitcoin, Ethereum and Dogecoin are replaced by wool, milk
          and bacon, while sheep, cow and pig represent hardware mining rigs.
        </Text>
        <Text>
          To get started in the crypto world, gold is used to represent fiat
          currency. Farm animals symbolize mine power on the blockchain. Wool,
          milk and bacon representing their respective currencies.
        </Text>
      </Section>
      <Section
        className='grid grid-cols-12 gap-4 lg:gap-6 xl:gap-12'
      ...
      <Section>
        ...
        <Text>
          As the LiveStock session progresses, increasingly complex blockchain
          concepts will be introduced, including Proof-of-Work algorithms,
          cryptocurrencies with varying volatilities, and soft- and hardware
          ledgers.
        </Text>
        <Text>
          Users can explore and experience these concepts and their choices will
          impact the outcome of the session.
        </Text>
      </Section>
      <Section variant='full' as='figure'>
        <Text variant='note' as='figcaption'>
      ...
      <Section>
        ...
        <Text>
          Healthy competition can spur creativity and encourage people to
          approach things from a different perspective.
        </Text>
        <Text>
          In Livestock, players can choose to store their products in either an
          their barn <em>(representing open wallets)</em> or a more secure,
          vault <em>(representing offline wallets)</em>.
        </Text>
        <Text>
          The vault is password-protected and impervious to theft{' '}
          <em>(blockchain hacks)</em> but losing your password means losing
          access to your funds <em>(similar as losing your private keys)</em>.
        </Text>
      </Section>
      <Section variant='full' as='figure'>
        <Image
      ...
      <Section>
        ...
        <Text>
          ...
          a new market for each session to increase unpredictability. With wool
          being stable and inexpensive, and bacon being expensive and unstable.
        </Text>
        <Text>
...
\`\`\`
      ...
      <aside>
        ...
        <Links
          title='References'
          links={[
            ['https://github.com/xiduzo/blockchaingame', 'Code (app)'],
            ['https://github.com/xiduzo/blockchainserver', 'Code (server)'],
          ]}
        />
      </aside>
    </>
