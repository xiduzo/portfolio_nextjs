    ...
    <>
      ...
      <Section>
        ...
        <Text size='sm'>
          ...
          . This was still a hidden feature at the time, changed constantly and
          did not seem to have any focus from Spotify.
        </Text>
      </Section>
      <Section>
        <Text as='h2' variant='subheading'>
        ...
        <Text>
          Music is a blend of personal expression and social connection. By
          creating a collaborative playlist, and sharing your favorite tunes, we
          create a social experience.
        </Text>
        <Text>
          We wanted to give the user a personal experience too. This is why
...
`}
      ...
      <Section>
        ...
        <Text>
          Although we want to keep users fully engaged in Fissa, we would never
          be able to do the exploration of music as well as Spotify does.
        </Text>
        <Text>
      ...
      <Section>
        ...
        <Text>
          Before I lose you in the details, I would like to invite you to
          experience Fissa yourself.
        </Text>
        <Text>
      ...
      <Section>
        ...
        <Text>
          Of course any app needs to work, what is the point of having a
          non-functioning app. Besides playing tracks at a party we wanted Fissa
        ...
        <Text>
          It was a fun exercise to match the right animal for the different
          states of Fissa.
        </Text>
      </Section>
      <Section
      ...
      <Section>
        ...
        <Text>
          ...
          , but most importantly they will be based on the tracks which are the
          most popular in <strong>your Fissa</strong>.
        </Text>
        <CodeBlock
          code={`
\`\`\`tsx
...
`}
      ...
      <Section>
        ...
        <Text>
          As the Fissa is a collaborative playlist, users determine the order of
          the songs. This is done by up- or down-voting songs. This proved to be
          the most challenging part of the project.
        </Text>
        <Text>
          So strap-on your seatbelt, the next part will contain a lot of nerd
          info.
        </Text>
      </Section>
      <Section
      ...
      <Section>
        <Text>
          Initially we stored the index of the songs directly into the database.
          This way we put an unique index on the track for data integrity, and
          we could easily sort the tracks by their index.
        </Text>
        <CodeBlock
          code={`
\`\`\`prisma
...
\`\`\`
        ...
        <Text as='ol'>
          ...
          <li>
            Users can up- or down-vote tracks anytime, leading to constant index
            changes. While this is not inherently problematic, it can disrupt
            ongoing index recalculations.
          </li>
          <li>
            Because of the unique index constraint in prisma (read postgres), we
            had to update it twice: once to clear the new index and once to
            update the moved tracks&apos; index.
          </li>
        </Text>
        <CodeBlock
          code={`
...
\`\`\`
        ...
        <Text>
          ...
          have <strong>10 seconds</strong> to perform any operation.
        </Text>
        <Text>
      ...
      <Section>
        ...
        <Text>
          Eventually we settled on inferring the position of a track based on
          its&apos; score. The score is updated each time a user votes on a
          track and the score will be cleared whenever the song is being played.
        </Text>
        <Text>
...
\`\`\`
        ...
        />
        <Text>
          This only leaves us with <strong>THE algorithm</strong> which is the
          heart of Fissa.
        </Text>
        <CodeBlock
          code={`
