        ...
        <>
            ...
            <Section>
                ...
                <Text>
                    For over 100 years,{" "}
                    <Link
                        href="https://www.royalfloraholland.com/en"
                        target="_blank"
                    >
                        Royal Flora Holland
                    </Link>{" "}
                    (RFH) has been a leading player in global flower trading and
                    hosts the worlds&apos; largest flower auction.
                </Text>
                <Text>
                    As a cooperative of growers, RFH has centralized the supply
                    of flowers and plants by combining multiple auction
                    locations.
                </Text>
                <Text>
            ...
            <Section>
                ...
                <Text>
                    This is evident in the digital interfaces and processes that
                    still reflect the traditional auctioning{" "}
                    <em>underneath the clock</em>.
                </Text>
                <Text>
                    The challenge, now, is to modernize the real-time auction
                    using the public cloud, while navigating a complex
                    environment where{" "}
                    <Link
            ...
            <Section>
                ...
                <Text>
                    Modernizing the technology stack by migrating from
                    monolithic applications to microservices and replacing old
                    desktop applications with web-based technologies. All the
                    while emphasizing user needs in the development process of
            ...
            <Section>
                <Alert icon="Brain" intent="success">
                    <Text>
                        All details have been left-out of the architecture
                        schematics for competitive reasons.
                    </Text>
                    <Text>
                        <Link
            ...
            <Section>
                ...
                <Text>
                    ...
                    has been the traditional way of selling flowers in the
                    Netherlands, and therefore at Royal Flora Holland.
                </Text>
                <Text>
                    This auction process involves transporting flowers, from all
                    over the world, to the auction site where auctioneers use a
            ...
            <Section>
                ...
                <Text>
                    During the automation of the flower auction, several tools
                ...
                <Text>
                    ...
                    allowed buyers to inspect flowers and plants without being
                    physically present at the auction.
                </Text>
                <Text>
                    While{" "}
            ...
            <Section>
                ...
                <Text>
                    While a lot of efford has been put into automize the
                    auction, to update the flower auction to modern standards,
                    we identified four areas that required improvement:
                </Text>
                <Text as="ol">
                    <li>
            ...
            <Section>
                ...
                <Text>
                    ...
                    . This architecture allows each service to be individually
                    scalable based on the required load for any given
                    (date-)time.
                </Text>
            </Section>
            <Section>
            ...
            <Section>
                ...
                <Text>
                    ...
                    to develop and test components in isolation, while also
            ...
            <Section>
                ...
                <Text>
                    ...
                    internet connection, including desktops, tablets, and even
                    phones.
                </Text>
            </Section>
            <Section>
            ...
            <Section>
                <Text>
                    The project is still under active development and is
                    currently in the{" "}
                    <Link
                ...
                <Text as="aside" className="mt-8 text-base">
                    <ol className="text-sm text-muted-foreground">
                        ...
                        <li>
                            ...
                            , the pilot phase has been successfully completed
                            and the system is{" "}
                            <Link
