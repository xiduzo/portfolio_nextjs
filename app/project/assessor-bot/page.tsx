        ...
        <>
            ...
            <Section>
                ...
                <Text>
                    ...
                    there has been a lot of controversy surrounding the use of
                    Large Language Models (LLMs) in education.
                </Text>
                <Text>
                    At the{" "}
                    ...
                    <em>competencies</em> and <em>indicators</em>. Since the
                    introduction of these LLMs (ChatGPT in particular) we have
                    seen an increase in amount of usage of these models in the
            ...
            <Section>
                ...
                <Text size="sm">
                    As we do see the value of generative technologies in the
                    creative field and are sure they are here to stay. We prefer
                    to guide students in the use of these technologies, and
                    allow for them to develop a critical view, instead of
                    banning it all together<sup>1</sup>.
                </Text>
                <Text size="sm">
                    By hosting a full week dedicated to experimenting with the
                    use of AI in the creative field, with the question to the
                    students to{" "}
                    <strong>
                        create a prompt-based product that uses LLM prompting
                        techniques, the product must do only one thing but do it
                        well
                    </strong>
                    , we explored and reflected opon the field of generative
                    technologies together.
                </Text>
                <Text as="aside" className="mt-8 text-base">
                    <ol className="text-sm text-muted-foreground">
                        <li>
                            We do now require the students to proved us with a
                            decleration of transparency in the use of AI in
                            submitted documents
                        </li>
                    </ol>
                </Text>
            ...
            <Section>
                ...
                <Text as="ul">
                    <li>
                        Getting designers to <strong>reflect</strong>, get
                        insight in their competencies, give direction
                    </li>
                    <li>
                        <strong>Take off pressure</strong> for reviewing design
                        work
                    </li>
                    <li>
                        Make the <strong>feedback</strong> loop easier and
                        faster
                    </li>
                </Text>
                <Text className="mt-24 text-center" size="sm">
                    <Link
                        href="/mdd-assessor-bot/portfolio_checker.pdf"
                        target="_blank"
                    >
                        See the whole pitch
                    </Link>
            ...
            <Section>
                <Alert intent="info" icon="Lightbulb">
                    ...
                    <Text>
                        This article will go into the technical details of
                        implementing such designs to a working product.
                    </Text>
                    <Text>
            ...
            <Section>
                ...
                <Text>
                    ...
                    by <code>LangChain</code> which made me confident enough
                    that I could build something similar and give a go at the{" "}
            ...
            <Section>
                ...
                <Text size="sm">
                    ...
                    &ldquo;surprisingly&rdquo; enough I struggled getting the
                    RAG properly set-up and running to provide valuable
                    feedback.
                </Text>
                <Text size="sm">
                    As I do not really have a clue on how to make a proper RAG
                    implementation I followed the documentation and came up with
                    something like:
                </Text>
                <CodeBlock
                    code={`
...
\`\`\`
                ...
                />
                <Text size="sm">
                    This vectorstore would then be populated with documents
            ...
            <Section>
                ...
                <Text as="ul" size="sm">
                    ...
                    <li>
                        ...
                        was not provided by the student and then give feedback
                        on that.
                    </li>
                </Text>
            </Section>
