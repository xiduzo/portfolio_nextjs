...
| **3 — Visuals (specs documented, artifacts pending)** | ⏳ Specs ready, only phase left |
| 4 — Verify and ship (tsc + build) | ✅ Green |
| 5 — Optional polish | ✅ Done (5a–5e); 5f deferred as judgement call |
